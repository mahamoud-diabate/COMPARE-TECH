...
const DATE =
  /^(janvier|february|january|march|april|may|june|july|august|september|october|november|december)/i;
...
async function scrapeCpus() {
  ...
  try {
    ...
    $('tr.odd, tr.even, tr.desk_odd, tr.desk_even, tr.smartphone_odd, tr.smartphone_even').each(
      (index, element) => {
