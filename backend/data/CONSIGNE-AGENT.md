...
_Texte autonome, à transmettre tel quel à l'agent. Il n'a besoin d'aucun autre
contexte._
...
Avant d'écrire une valeur, demande-toi : _est-ce que ce chiffre est la grandeur
que le champ désigne, ou l'appréciation de quelqu'un sur cette grandeur ?_
